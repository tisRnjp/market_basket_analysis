...
namespace Major_Project.Controllers
{
    public class ProductsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ProductID,CategoryID,Title,Price,Description")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ProductID,CategoryID,Title,Price,Description")] Product product)
        {
            if (ModelState.IsValid)
            {
